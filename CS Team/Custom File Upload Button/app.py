...
# MySQL database
conn = mysql.connector.connect(host="localhost", user="root", passwd="sahil11", db="project")
...
def insert_into_database(data):
    ...
    try:
        if data:
            cursor.executemany("INSERT INTO content (question, answer, tag) VALUES (%s, %s, %s)", data)
            conn.commit()
